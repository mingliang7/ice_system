...
Template.cpanel_exchange.events({
  ...
  'click .update': function (e, t) {
    ...
    alertify.exchange(fa("pencil", "Exchange"), renderTemplate(Template.cpanel_exchangeUpdate,
        data))
      .maximize();
  },
  ...
  'click .show': function (e, t) {
    ...
    alertify.alert(fa("eye", "Exchange"), renderTemplate(Template.cpanel_exchangeShow,
      this).html);
  }
});
