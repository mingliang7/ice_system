...
Template.cpanel_user.events({
  ...
  'click .update': function (e, t) {
    ...
    alertify.user(fa("pencil", "User"), renderTemplate(Template.cpanel_userUpdate,
        data))
      .maximize();
  },
  ...
  'click .show': function (e, t) {
    ...
    alertify.alert(fa("eye", "User"), renderTemplate(Template.cpanel_userShow,
      this).html);
  }
});
...
AutoForm.hooks({
  ...
  cpanel_userUpdate: {
    onSubmit: function (insertDoc, updateDoc, currentDoc) {
      ...
      Meteor.call('userUpdate', currentDoc._id, insertDoc, function (
        error, result) {
        if (error) {
          alertify.error(error.message);
        }
